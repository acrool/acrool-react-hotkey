...
- Create an [issue](https://github.com/acrool/acrool-react-hotkey/issues) on GitHub, if you have found a bug
...
- Submit an [issue](https://github.com/acrool/acrool-react-hotkey/issues), assuming one does not already exist.
